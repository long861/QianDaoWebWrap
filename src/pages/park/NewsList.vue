  ...
  <div v-if="isRealy">
    <el-col :span="24" class="toolbar">
      <el-form :inline="true" @submit.native.prevent style="padding-right:20px;overflow: hidden;">
        <el-form-item>
          <el-input v-model="tags" auto-complete="off" placeholder="请输入类别关键词">
            <template slot="prepend">按类别查询:</template>
          </el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    addNews() {
      this.$router.push({ path: "/park/createNews", name: "创建动态" });
    },
